...
namespace Grid
{
    ...
    public abstract class Grid<TGridObject>
    {
		...
		public abstract Vector3 GetCellPosition(Vector3 worldPosition);
		...
		public bool Switch(Vector2 worldPosition1, Vector2 worldPosition2)
		{
			worldPosition1 = GetCellPosition(worldPosition1);
			worldPosition2 = GetCellPosition(worldPosition2);
			return Switch((int)worldPosition1.x, (int)worldPosition1.y, (int)worldPosition2.x, (int)worldPosition2.y);
		}
